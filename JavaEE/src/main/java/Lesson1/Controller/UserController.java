...
public class UserController {
    ...
    public String updateUser(@ModelAttribute User user, Model model, HttpSession session) throws UnauthorizedException {
    ...
    public String deleteUser(HttpSession session, Model model) throws UnauthorizedException {
    ...
    public String logoutUser(HttpSession session) throws UnauthorizedException {
        if (session.getAttribute("loginStatus") == null) throw new UnauthorizedException("Already Logged Out");
